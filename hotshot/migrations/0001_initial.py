# Generated by Django 2.1.5 on 2019-01-17 13:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uid', models.CharField(default='', max_length=13, primary_key=True, serialize=False, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='LSPHotVideoModel',
            fields=[
                ('created', models.DateTimeField(auto_now=True)),
                ('id', models.AutoField(primary_key=True, serialize=False)),
